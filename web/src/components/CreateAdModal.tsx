...
export function CreateAdModal (){
    ...
    useEffect(() => {
     ...
     async  function handLeCreateAd(event: FormEvent ){
        ...
        const fomData = new FormData(event.target as HTMLFormElement)
        ...
        <Dialog.Title className='text-3xl font-black'>Publique um anúncio</Dialog.Title>
          ...
          <form onSubmit={handLeCreateAd} className='mt-8 flex flex-col gap-4'>
            ...
            <select name='game'  className='bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-500 appearance-none'id='game' defaultValue=""  >
                ...
                <option disabled   value="Seleciona o game que deseja jogar">Seleciona o game que deseja jogar</option>
            ...
            <div className='flex flex-col gap-2'>
            <label htmlFor="main">Seu nome (ou nickname)</label>
              <Input name='main' id='main' placeholder='Como te chamam dento do game?' />
            </div>
